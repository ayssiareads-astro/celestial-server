...
const AUTH = "Basic " + Buffer.from("652123:ak-4803abdc5f22b1d84fe9cf319a3bb889eb227dae").toString("base64");
...
app.post("/chart", async (req, res) => {
  try {
    ...
    const astroRes = await fetch("https://json.astrologyapi.com/v1/western_horoscope", { method: "POST", headers: { "Authorization": AUTH, "Content-Type": "application/json" }, body: JSON.stringify({ day, month, year, hour, min, lat, lon, tzone, house_type: "placidus", is_asteroids: "false" }) });
...
app.listen(process.env.PORT || 3001, "0.0.0.0", () => console.log("Server started on port " + (process.env.PORT || 3001)))
